...
- Note: this only controls commit messages. It cannot suppress the "Generated by Claude Code" footer GitHub PR bodies/comments get server-side — that's injected by the platform itself, not by repo instructions.
